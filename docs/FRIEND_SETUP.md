...
## Step 2 — Download AC Companion
Go to: https://github.com/ShinobiFPV/AC1Companion/releases/latest
Download: AC-Companion-Setup-x.x.x.exe
...
- Your handle and color (shown to the crew in Events and Comms)
- Backend connection (pre-filled — just hit Test Connection)
