...
const stereoRouter        = require('./routes/stereo')
...
app.use('/api/cluster', createClusterRouter(io))
app.use('/api/telemetry', createTelemetryRouter(io))
app.use('/api/hosts', hostsRouter)
app.use('/api/admin', adminRouter)
app.use('/api/stereo', stereoRouter)
