...
function SystemHealth({ showToast }) {
  ...
  return (
    <Card accent={C.borderHi}>
      <SectionHead children="System health" sub="Backend process running on shinobi" />
      {health ? (
      ...
      <Tooltip text={confirming ? 'Click again to confirm — this restarts the live backend for everyone' : 'Restart the ac-companion service on shinobi'}>
