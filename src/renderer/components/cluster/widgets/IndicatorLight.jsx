...
// Display only — no input. `telemetryBind` is required per the spec (nothing
// to show otherwise); a missing bind or null frame just reads as off rather
// than throwing, per the "never crash on null telemetry" constraint.
